...
class autofill_constants_AutoFillConstants {
}
autofill_constants_AutoFillConstants.EmailFieldNames = [
    // English
    "email",
    "email address",
    "e-mail",
...
autofill_constants_AutoFillConstants.UsernameFieldNames = [
    // English
    "username",
    "user name",
    "userid",
...
autofill_constants_AutoFillConstants.TotpFieldNames = [
    "totp",
    "totpcode",
    "2facode",
    "approvals_code",
...
autofill_constants_AutoFillConstants.RecoveryCodeFieldNames = ["backup", "recovery"];
autofill_constants_AutoFillConstants.AmbiguousTotpFieldNames = ["code", "pin", "otc", "otp", "2fa", "mfa"];
autofill_constants_AutoFillConstants.SearchFieldNames = ["search", "query", "find", "go"];
autofill_constants_AutoFillConstants.NewEmailFieldKeywords = [
    "new-email",
    "newemail",
    "new email",
    "neue e-mail",
];
autofill_constants_AutoFillConstants.RegistrationKeywords = [
    "register",
    "signup",
    "sign-up",
    "join",
 ...
 */
autofill_constants_AutoFillConstants.AccountCreationFieldKeywords = [
    "register",
    "registration",
    "create password",
    "create a password",
 ...
 */
autofill_constants_AutoFillConstants.UpdatePasswordFieldKeywords = [
    "update password",
    "change password",
    "current password",
    "kennwort ändern",
 ...
 */
autofill_constants_AutoFillConstants.NonLoginFormKeywords = [
    "newsletter",
...
autofill_constants_AutoFillConstants.FieldIgnoreList = ["captcha", "findanything", "forgot"];
autofill_constants_AutoFillConstants.PasswordFieldExcludeList = [
    "hint",
    ...autofill_constants_AutoFillConstants.FieldIgnoreList,
    ...autofill_constants_AutoFillConstants.TotpFieldNames,
];
autofill_constants_AutoFillConstants.ExcludedAutofillLoginTypes = [
    "hidden",
    "file",
    "button",
    "image",
...
autofill_constants_AutoFillConstants.ExcludedAutofillTypes = [
    "radio",
    "checkbox",
    ...autofill_constants_AutoFillConstants.ExcludedAutofillLoginTypes,
];
autofill_constants_AutoFillConstants.ExcludedInlineMenuTypes = [
    "textarea",
    ...autofill_constants_AutoFillConstants.ExcludedAutofillTypes,
];
/** HTML elements for form fields */
autofill_constants_AutoFillConstants.FieldElements = ["input", "select", "textarea"];
autofill_constants_AutoFillConstants.AutocompleteCurrentPassword = "current-password";
autofill_constants_AutoFillConstants.AutocompleteNewPassword = "new-password";
autofill_constants_AutoFillConstants.ExcludedIdentityAutocompleteTypes = new Set([
    autofill_constants_AutoFillConstants.AutocompleteCurrentPassword,
    autofill_constants_AutoFillConstants.AutocompleteNewPassword,
]);
...
class CollectAutofillContentService {
    constructor(domElementVisibilityService, domQueryService, autofillOverlayContentService) {
        ...
        this.debouncedProcessMutations = debounce(() => this.processMutations(), 100);
    ...
    containsChildField(element) {
        if (nodeIsElement(element)) {
            const fields = autofill_constants_AutoFillConstants.FieldElements.join(", ");
    ...
    isAutofillElementNodeMutated(nodes, isRemovingNodes = false) {
        ...
        for (let index = 0; index < nodes.length; index++) {
            ...
            const autofillElements = this.domQueryService.query(node, `form, ${this.formFieldQueryString}`, (walkerNode) => nodeIsFormElement(walkerNode) || this.isNodeFormFieldElement(walkerNode), (_a = this.mutationObserver) !== null && _a !== void 0 ? _a : undefined, true);
    ...
    deleteCachedAutofillElement(element) {
        ...
        if (this.autofillFieldElements.has(element)) {
            ...
            if (autofillFieldData === null || autofillFieldData === void 0 ? void 0 : autofillFieldData.opid) {
 ...
 */
function fieldContainsKeyword(field, keywords, substringMatch = true) {
