...
const PDFSecurity_1 = tslib_1.__importDefault(require("../core/security/PDFSecurity"));
...
class PDFDocument {
    ...
    static load(pdf, options = {}) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { ignoreEncryption = false, parseSpeed = PDFDocumentOptions_1.ParseSpeeds.Slow, throwOnInvalidObject = false, warnOnInvalidObjects = false, updateMetadata = true, capNumbers = false, password, forIncrementalUpdate = false, } = options;
