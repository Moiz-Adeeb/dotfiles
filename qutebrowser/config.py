...
# Keybindings
config.bind('tt', 'config-cycle tabs.width 40 400')
config.bind('cc', 'config-cycle tabs.show never multiple')
config.bind('gg', 'config-cycle statusbar.show always never')
...
# Inactive tab colors (to match your black bar)
...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/moiz/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/moiz/.local/share/qutebrowser/userscripts/*')
